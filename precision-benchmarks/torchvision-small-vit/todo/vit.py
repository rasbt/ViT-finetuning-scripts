...
class VisionTransformer(nn.Module):
    ...
    def __init__(
        ...
        if isinstance(self.conv_proj, nn.Conv2d):
            ...
            nn.init.normal_(self.conv_proj.weight, std=math.sqrt(1 / fan_in))
        ...
        if hasattr(self.heads, "pre_logits") and isinstance(self.heads.pre_logits, nn.Linear):
            ...
            nn.init.normal_(self.heads.pre_logits.weight, std=math.sqrt(1 / fan_in))
...
def vit_b_17(*, weights: Optional[ViT_B_16_Weights] = None, progress: bool = True, **kwargs: Any) -> VisionTransformer:
    """
...
def vit_b_33(*, weights: Optional[ViT_B_32_Weights] = None, progress: bool = True, **kwargs: Any) -> VisionTransformer:
    """
...
def vit_l_17(*, weights: Optional[ViT_L_16_Weights] = None, progress: bool = True, **kwargs: Any) -> VisionTransformer:
    """
...
def vit_l_33(*, weights: Optional[ViT_L_32_Weights] = None, progress: bool = True, **kwargs: Any) -> VisionTransformer:
    """
...
def vit_h_15(*, weights: Optional[ViT_H_14_Weights] = None, progress: bool = True, **kwargs: Any) -> VisionTransformer:
    """
